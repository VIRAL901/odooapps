...
class TestSchool(common.TransactionCase):
    def setUp(self):
        ...
        self.school_id = self.env.ref("spd_school.demo_school_1")
        self.standard_medium = self.env.ref("spd_school.demo_standard_medium_1")
        self.year = self.env.ref("spd_school.demo_academic_year_2")
        self.currency_id = self.env.ref("base.INR")
        self.sch = self.env.ref("spd_school.demo_school_1")
        self.country_id = self.env.ref("base.in")
        self.std = self.env.ref("spd_school.demo_standard_standard_1")
        self.state_id = self.env.ref("base.state_in_gj")
        self.subject1 = self.env.ref("spd_school.demo_subject_subject_1")
        self.subject2 = self.env.ref("spd_school.demo_subject_subject_2")
        self.student_student = self.env.ref("spd_school.demo_student_student_2")
        self.student_done = self.env.ref("spd_school.demo_student_student_6")
        self.parent = self.env.ref("spd_school.demo_student_parent_1")
